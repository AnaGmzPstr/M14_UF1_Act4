...
function exercici3() {
    ...
    const preusIncrementats = preus.map(preu => Math.round(preu * 1.1));
...
//Exerici 6
function exercici6() {
    let resultat = document.getElementById("res6");
    ...
    //Mostrem el objecte
    resultat.textContent = JSON.stringify(producteObjecte, null, 2);
}
